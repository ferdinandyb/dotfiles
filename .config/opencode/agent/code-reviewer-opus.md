---
description: Independent code reviewer running on Claude Opus 4.8 (Anthropic). Spawned in parallel with a Gemini reviewer; reports are compared by a neutral merger.
mode: subagent
hidden: true
